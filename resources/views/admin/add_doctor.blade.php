      ...
      <div class="container-fluid page-body-wrapper">
       ...
       <div class="container mx-auto my-5">
        ...
        <!---Success Message of Doctor added  -->
         ...
         @endif
           <div class="card">
           <div class="card-header text-center"><h1>Add Doctor</h1></div>
             <div class="form-body">
               ...
               <form action="{{url('upload_doctor')}}" method="POST" enctype="multipart/form-data">
                @csrf
                   <div class="mb-3">
                       ...
                       <input type="text" class="form-control bg-white" placeholder="Add Your Doctor" name="doctorname" required >
                   </div>
                   <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select  id="" class="form-control text-light" name="speciality" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control bg-white" name="room" required>
                </div>
                <div class="mb-3">
